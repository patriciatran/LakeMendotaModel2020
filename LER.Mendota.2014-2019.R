...
# Then you can download LakeEnsemblrR
devtools::install_github('aemon-j/LakeEnsemblR')
devtools::install_github("robertladwig/LakeEnsemblR") # this fixes the simstrat error
...
## Run the ensemble
# Note to myself: to run GOTMr I need to have netCDF installed on my computer (brew install netcdf)
#run_ensemble("LakeEnsemblR.yaml", model = c("GOTM"))

#run_ensemble("LakeEnsemblR.yaml", model = c("FLake", "GLM", "GOTM",
#                                            "Simstrat", "MyLake"))

run_ensemble("LakeEnsemblR.yaml", model = c("FLake","GLM", "GOTM", "MyLake", "Simstrat"))
...
ggsave("../Plots/Plots-2014-2019/LER.with.inflow..a.seiche.0.001.pdf", width = 11, height = 8.5, units = "in")
...
for (i in 1:length(depth)){
  ...
  ggsave(paste0("../Plots/Plots-2014-2019/Plots_residuals_",depth[i],".png"), height = 8.5, width = 11, units = "in")
  print(depth[i])
}
